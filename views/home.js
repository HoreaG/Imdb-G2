 ...
 $(document).ready(()=>{
    ...
    function searchMovies (filterList, input){
        ...
        searchList.fetchMovieList(filterList, input).then((item)=>{
            ...
            const searchGlobalContainer = document.getElementById('altceva');
            searchGlobalContainer.innerHTML = "";
      ...
      searchGlobalContainer.appendChild(moviesGlobalContainer);
            console.log('RES', item.results);
        for( let i = 0; i < item.results.length; i++){
            console.log("Result of search: ",item.results[i]);
            searchGlobalContainer.style.display = "block";
